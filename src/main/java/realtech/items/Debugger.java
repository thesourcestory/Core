            ...
            for (int j = 2; j <= 255; j++) {
                for (int i = -75; i <= 75; i++) {
                    for (int k = -75; k <= 75; k++) {
                        ...
                        IBlockState redstone = Blocks.REDSTONE_ORE.getDefaultState();
                        ...
                        IBlockState darkoakleaf = Blocks.LEAVES2.getDefaultState().withProperty(BlockNewLeaf.VARIANT, BlockPlanks.EnumType.DARK_OAK);
                        ...
                        if(y != oldy)
                            logger.devInfo("currently at y:" + blockPos.getY());
                        oldy = y;
                    }
                }
            }
